...
@Component
class UserStrategyActivatedEventHandler(
    ...
    @KafkaListener(topics = [UserStrategyActivatedEvent.TOPIC])
    fun handle(message: String) {
        val payload = debeziumMessageParser.parsePayload<UserStrategyActivatedEvent.Payload>(rawMessage = message)
        log.info { "handle UserStrategyActivatedEvent. Received payload: $payload" }
